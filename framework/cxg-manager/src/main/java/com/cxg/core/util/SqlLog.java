...
import com.cxg.core.util.format.jdbc.util.FormatStyle;


/**
 * @ClassName: SqlLog
* @Description: SQL执行Log工具类
* @author haipeng
* @date 2017年1月8日
 */
public class SqlLog {
	...
	//是否打印log
	private static final String islog = properties.getProperty("log4j.cxg.sql.log");
	//是否格式化
	private static final String farmat = properties.getProperty("log4j.cxg.sql.format");
